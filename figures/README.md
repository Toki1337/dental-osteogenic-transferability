# Figures — provenance (current Fig 1–6 system)

The submission figure set is **`figures/pub/Fig1`–`Fig6`** (PNG + PDF). Everything in
...
| **Fig6_priority** | Connectivity-map convergence (dexamethasone + HDAC inhibitors) + integrated priority; no robust genetic double-evidence (GREM2 pleiotropy artifact; only weak SRGN); tiers labelled "eBMD-MR-associated" (not "causal") | `R/real_run_fig5fig6_corrected.R` |
